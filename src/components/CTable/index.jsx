...
export const CTable = ({ children, count, page,rowsPerPage, setCurrentPage=()=>{},setPageCount=()=>{},setRowsPerPage=()=>{}, removableHeight = 186, disablePagination }) => {
  ...
  return (
    <Paper className="CTableContainer">
      ...
      {!disablePagination && <CPagination count={count} page={page} rowsPerPage={rowsPerPage} setPageCount={setPageCount} setCurrentPage={setCurrentPage} setRowsPerPage={setRowsPerPage}/>}
    </Paper>
  )
}
